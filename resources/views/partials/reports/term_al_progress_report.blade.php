...
@foreach ($students as $student)
                    ...
                    <div class="col-lg-12">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th class="text-center" style="background-color:#61c4e3 !important">Grade</th>
                                <th class="text-center" style="background-color:#e3df59 !important">Grade Average</th>
                            </tr>
                            @php $i=1; @endphp
                            @php
                                    ...
                                    <div class="col-lg-12">
                                        <tr>
                                            ...
                                            @if($exam->pivot->is_absent==0)
                                                ...
                                                <td class="text-center">{{subject_grade_average($exam,App\Subject::find($exam->pivot->subject_id))}}</td>
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <tr class="text-center">
                                            ...
                                            <td  style="background-color:#f3c2f9 !important">Class 1st average: {{number_format($examRank->pivot->rank_one_average,2)}}</td>
                                        </tr>
                                    </div>
                                </div>
                            @endif
    ...
    @if(isset($exam))
        ...
        function drawChart() {
            ...
            //var chart = new google.charts.Bar(document.getElementById("chart_{{$student->id}}"));
