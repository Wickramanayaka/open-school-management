		...
		<div class="row">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                @else
                                    ...
                                    @if($exam_get_param->has_grade_average==1)<th class="text-center" style="background-color:#e3df59 !important">Grade Average</th>@endif
                                @endif
                                        ...
                                        <tr>
                                            ...
                                            @else
                                                @if($exam->pivot->is_absent==0)
                                                    ...
                                                    <td class="text-center">{{$exam->pivot->mark_grade}}</td>
                                                    @if($exam_get_param->has_grade_average==1)<td class="text-center">{{subject_grade_average($exam,App\Subject::find($exam->pivot->subject_id))}}</td>@endif
                                                @else
                                                    <td class="text-center">ab</td>
                                                    <td>&nbsp;</td>
                                                @endif
                ...
                <div class="row" style="margin-top:20px; margin-bottom:0px;">
                    <div class="col-md-10 col-md-offset-1">
                        <img src="{{asset('images/chart_title_term1.png')}}" alt="" class="img-responsive">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
