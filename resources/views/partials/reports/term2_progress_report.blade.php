                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <tr class="text-center">
                                                <td  style="background-color:#61c4e3 !important"><strong>Rank: {{$examRank->pivot->rank}}</strong></td>
                                                <td  style="background-color:#f7cf94 !important"><strong>Total: {{$examRank->pivot->total}}</strong></td>
                                                <td  style="background-color:#f9f7ac !important"><strong>Average: {{number_format($examRank->pivot->average,2)}}</strong></td>
                                                <td  style="background-color:#f3c2f9 !important"><strong>Class 1<sup>st</sup> average: {{number_format($examRank->pivot->rank_one_average,2)}}</strong></td>
                                            </tr>
                                        </div>
                                    </div>
                                @endif
