...
@foreach ($students as $student)
		...
		<div class="row">
                    ...
                    <div class="col-lg-12">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th class="text-center" style="background-color:#fb6362 !important">Student Marks</th>
                                <th class="text-center" style="background-color:#e3df59 !important">Grade</th>
                                <th class="text-center" style="background-color:#61c4e3 !important">Term One Marks</th>
                                <th class="text-center" style="background-color:#60e75d !important">Term Two Marks</th>
                            </tr>
                            @php $i=1; @endphp
                            @php
                                    ...
                                    <div class="col-lg-12">
                                        <tr>
                                            ...
                                            @if($exam->pivot->is_absent==0)
                                                ...
                                                <td class="text-center">{{term_one_al_3($student,$exam,App\Subject::find($exam->pivot->subject_id))}}</td>
                                                <td class="text-center">{{term_two_al_3($student,$exam,App\Subject::find($exam->pivot->subject_id))}}</td>
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <tr class="text-center">
                                            ...
                                            <td  style="background-color:#f7cf94 !important">Total: {{$examRank->pivot->total}}</td>
                                            <td  style="background-color:#f9f7ac !important">Average: {{number_format($examRank->pivot->average,2)}}</td>
                                            <td  style="background-color:#f3c2f9 !important">Class 1<sup>st</sup> average: {{number_format($examRank->pivot->rank_one_average,2)}}</td>
                                        </tr>
                                    </div>
                                </div>
                            @endif
                ...
                <div class="row" style="margin-top:20px; margin-bottom:0px;">
                    <div class="col-md-10 col-md-offset-1">
                        <img src="{{asset('images/chart_title_term2.png')}}" alt="" class="img-responsive">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
    ...
    @if(isset($exam))
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
            {!!chart_data_al($student,$exam_get_param)!!}
            ]);
