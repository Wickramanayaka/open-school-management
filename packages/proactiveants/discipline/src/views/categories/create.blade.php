    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">New Disobedience Category</div>
                <div class="panel-body">
                    @include('partials.alert')
                    <form method="POST" action="{{ url('discipline/category/') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="point_deduct" type="text" class="form-control" name="point_deduct" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_critical" value="1"> Critical
                                    </label>
                                </div>
                            </div>
                            </div>
