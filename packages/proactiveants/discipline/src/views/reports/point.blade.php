...
<form method="POST" action="#" id="main-form">
    <div class="panel panel-primary" id="content-panel">
        <div class="panel-heading">
            Student Discipline Point Detail Filters
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 filter-box-last">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="point_from">Point From</label>
                                <input type="text" class="form-control" autocomplete="off" id="point_from" name="point_from" placeholder="From">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" autocomplete="off" id="point_to" name="point_to" placeholder="To">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $("#main-form").submit(function(e){
        ...
        $("#loader").show();
        $.ajax({
        url: "{{url('./discipline/report/student')}}",
        type: 'POST',
        data: {
            ...
            date_to: $("#date_to").val(),
            point_to: $("#point_to").val(),
            point_from: $("#point_from").val()
        },
