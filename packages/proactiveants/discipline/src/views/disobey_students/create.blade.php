        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ url('discipline/student/') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::select('disobedience_id',$list,null, ['class' => 'form-control'])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="charge_sheet_number" type="text" class="form-control" name="charge_sheet_number">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="remark" type="text" class="form-control" name="remark">{{ old('remark') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
