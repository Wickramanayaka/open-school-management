...
class DisciplinePointEarnMonthlyManual extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'discipline:monthly';
     ...
     * @var string
     */
    protected $description = 'Student monthly discipline point earning task.';
    ...
    public function handle()
    {
        ...
        $this->info('This process can be run on any month within the academic year');
        $date = $this->ask('Which date the process need be run? (2018-01-31)');
